...
public class AnnoyInner1 extends JFrame{
	...
	public AnnoyInner1() {
		...
		ActionListener listener = new MyActionListener(this);	// 리스너 객체 생성 
...
class MyActionListener implements ActionListener{	// 리스너 인터페이스를 구현
	...
	public void actionPerformed(ActionEvent e) {
		JOptionPane.showMessageDialog(window, window.message);	// 버튼이 클릭되면 메시지 박스 띄우기 
	}
}
